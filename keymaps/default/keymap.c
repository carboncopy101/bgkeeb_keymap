 ...
 *        `------+------'                                       `------+------'
 *                  ,--------------------.    ,--------------------.
 *                  |  '  | LOWER| ENTER |    |Space| RAISE| BckSpc|
 *                  `--------------------'    `--------------------.
 */
...
[_COLEMAK] = LAYOUT_split_3x5_4(
  ...
  LCTL_T(KC_A), LGUI_T(KC_R), LALT_T(KC_S), LSFT_T(KC_T), KC_D,         KC_H,    RSFT_T(KC_N), RALT_T(KC_E), RGUI_T(KC_I), RCTL_T(KC_O),
  KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,         KC_K,    KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,
                KC_MPLY,      KC_QUOT,        LOWER,       KC_ENT,      KC_SPC, RAISE,       KC_BSPC,        KC_MUTE
),
